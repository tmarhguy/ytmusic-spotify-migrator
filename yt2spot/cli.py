...
@click.option(
    "--public/--private",
    default=True,
    help="Make the playlist public or private"
)
@click.option(
    "--dry-run",
    is_flag=True,
...
@click.option(
    "--fuzzy",
    is_flag=True,
    help="Enable fuzzy matching for ambiguous songs"
)
@click.option(
    "--interactive",
    is_flag=True,
    help="Prompt for user input on ambiguous matches"
)
@click.option(
    "--force-recreate",
    is_flag=True,
...
def main(
    ...
    try:
        ...
        console.print("[yellow]🚧 Core pipeline implementation coming in Sprint 1![/yellow]")
...
# Add the init-config subcommand
